...
2. **Target location**: Should this be a personal skill (~/.agent/skills/) or project skill (.agent/skills/)?
...
- "Where should this skill be stored?" with options like ["Personal (~/.agent/skills/)", "Project (.agent/skills/)"]
...
**IMPORTANT**: Never create skills in `~/.agent/skills-cursor/`. This directory is reserved for Cursor's internal built-in skills and is managed automatically by the system.
